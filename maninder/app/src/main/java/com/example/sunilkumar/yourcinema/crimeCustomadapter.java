...
public class crimeCustomadapter extends ArrayAdapter {
    ...
    public crimeCustomadapter(Context context, ArrayList<String> idlist,ArrayList<String> namelist,ArrayList<String> picnamelist,ArrayList<String> descrlist,ArrayList<String> reldatelist,ArrayList<Float> ratlist)
    ...
    public View getView( final int position, View convertView, ViewGroup parent) {
        ...
        View customview = inflater.inflate(R.layout.activity_crime_customadapter, null);
