...
public class comedyCustomadapter extends ArrayAdapter {
    ...
    public comedyCustomadapter(Context context, ArrayList<String> idlist,ArrayList<String> namelist,ArrayList<String> picnamelist,ArrayList<String> descrlist,ArrayList<String> reldatelist,ArrayList<Float> ratlist)
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        View customview=inflater.inflate(R.layout.activity_comedy_customadapter,null);
        ...
        rates.setRating(ratlist.get(position));
